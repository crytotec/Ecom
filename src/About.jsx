...
function About() {
   ...
   <div>
       ...
       <div className='w-1/2  flex-col text-white text-justify flex justify-center items-center mx-auto'>
               <h1 className='text-2xl text-gray-700 font-bold'>About US</h1>
            <p className='text-[12px]'>Our journey began with a vision to make quality and stylish clothing accessible to everyone.
       ...
       <div className='w-1/2 h-[200px] sm:h-[100px] flex-col text-white text-justify flex justify-start items-start mx-auto'>
               <h1 className='text-2xl text-start text-gray-700 font-bold'> Mission Statement</h1>
            <p className='text-[12px] text-gray-500'>Our mission is to empower people with confidence through clothing that fits perfectly 
    ...
    <div className='grid grid-cols-2 w-1/2 py-4 justify-center mx-auto'>
        <img src={b5}  className="sm:h-[150px] h-[100px] rounded-md w-[80px] sm:w-[200px] object-cover"/>
        <ul className='list-inside h-[120px] text-justify'>
        ...
        <div className='bg-[rgb(173,139,49)] mb-2 w-1/2 mx-auto rounded m flex justify-center items-center h-[100px]'>
         <h1 className='text-white text-[10px] md:text-[15px] cursor-pointer mx-4'>
